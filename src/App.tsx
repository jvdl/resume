      ...
      <main className="resume-main">
        <header className="resume-header">
          ...
          <ul>
            ...
            <li>
              <GitHub />
              <a href="https://github.com/jvdl" target="_blank" rel="noreferrer">
                GitHub
              </a>
            </li>
            <li className="download-link">
              <Download />
              <a
                href="./files/john-van-der-loo-resume.pdf"
                download
                target="_blank"
                rel="noreferrer"
              >
        ...
        <section className="resume-section summary">
          <h2>Summary</h2>
          <p>
            With over 20 years of web development experience, I am a frontend expert who enjoys
            building great, accessible UI/UX implementations that help make the world a better
            place.
          </p>
          <p>
            I specialize in <b>JavaScript</b>, <b>TypeScript</b>, <b>CSS</b>, <b>HTML</b>, and{" "}
            <b>React</b>. Using my skills and experience, I focus on <b>accessibility</b>,{" "}
            <b>usability</b>, and <b>user experience</b> to build solutions that make a positive
            impact. I am passionate about working on projects that help{" "}
            <b>developer and team productivity</b>, and I always aim to remain <b>adaptable</b> and{" "}
            <b>flexible</b>. I have experience working in a wide variety of environments and tech
            stacks, and I am always eager to take on new challenges and expand my skill set.
          </p>
        </section>
        ...
        <section className="resume-section recent-experience">
          ...
          <article className="job">
            ...
            <div className="role">
              ...
              <ul>
                <li>
                  <b>Led migration</b> from Webpack to Vite, reducing build times and the developer
                  feedback loop. Modernizing the tech stack to <b>improve team productivity</b>.
                </li>
                <li>
                  Recognized gaps in <b>end-to-end testing</b> coverage. Architected and implemented
                  a new <b>Playwright</b> e2e test suite, replacing legacy Selenium setup to{" "}
                  <b>increase test reliability</b> and reduce manual QA burden.
                </li>
                <li>
                  <b>Streamlined CI/CD infrastructure</b> by <b>improving processes</b> and
                  migrating pipelines, reducing deployment failures and{" "}
                  <b>increasing release confidence</b>.
                </li>
                <li>
                  Drove migration to <b>Vitest</b>, establishing a modern, unified{" "}
                  <b>testing strategy</b> that improved test execution speed and{" "}
                  <b>developer experience</b>.
                </li>
                <li>
                  Eliminated risky manual database operations by building a new admin application
                  for SaaS configuration and resource management. Reduced operational overhead and{" "}
                  <b>significantly decreased production incident risk</b>.
                </li>
                <li>
                  Resolved lack of <b>visibility into analytics data</b> by implementing a fully
                  typed analytics client schema. Enabled teams to clearly understand available
                  events and data structures, <b>improving data quality</b> and{" "}
                  <b>analytics reliability</b>.
                </li>
              </ul>
            </div>
          </article>
          ...
          <article className="job">
            ...
            <div className="role">
              ...
              <ul>
                <li>
                  Rapidly ramped up on a large legacy codebase and domain knowledge to contribute
                  meaningfully within weeks
                </li>
                <li>
                  Led modernization efforts that <b>increased testing surface</b>, enabling faster
                  feature delivery by reducing manual testing effort.
                </li>
                <li>
                  Collaborated on the secure communication platform serving whistleblowers and
                  organizations, ensuring reliability and data integrity.
                </li>
              </ul>
            </div>
          </article>
          ...
          <article className="job">
            ...
            <div className="role">
              ...
              <ul>
                <li>
                  Spearheaded Pathzero's <b>design system</b> and set it up for success, enabling
                  the team to build features faster with a more <b>consistent user experience</b>{" "}
                  across the platform.
                </li>
                <li>
                  Led frontend development efforts <b>establishing architecture standards</b> and{" "}
                  <b>code quality practices</b> that reduced bugs and improved team velocity.
                </li>
                <li>
                  Managed greenfield projects and legacy modernization initiatives that improved
                  application performance and reduced technical debt, resulting in faster feature
                  delivery and improved user satisfaction.
                </li>
              </ul>
            </div>
            <div className="role">
              ...
              <ul>
                <li>
                  Led the "Customer Journey" team, <b>driving UX and usability improvements</b>{" "}
                  across the core application
                </li>
                <li>
                  Established and developed the design system with{" "}
                  <b>standards, guidelines, and tooling</b> to improve team efficiency
                </li>
            ...
            <div className="role">
              ...
              <ul>
                <li>
                  Made the world a little greener at Pathzero, an easy to use carbon communications
                  platform
                </li>
                <li>
                  Quickly ramped up on <b>Vue.js</b> and <b>GraphQL</b> while maintaining{" "}
                  <b>high code quality standards</b>
                </li>
                <li>
                  Implemented <b>responsive UI components</b> and improved application performance
                </li>
                <li>
                  Collaborated with design and backend teams to deliver cohesive features across the
                  stack
                </li>
              </ul>
            </div>
        ...
        <section className="resume-section previous-experience">
          <h2>
            Previous experience{" "}
            <button onClick={toggleAllPreviousExperience}>
            ...
            <details open={allOpen}>
              ...
              <div className="role">
                <ul>
                  ...
                  <li>
                    HTML5, CSS, JavaScript (jQuery, React, Backbone.js), with occasional PHP and
                    Node.js
                  </li>
          ...
          <article className="job">
            <details open={allOpen}>
              ...
              <div className="role">
                <ul>
                  <li>
                    Programming front-end interfaces including websites, landing pages, microsites,
                    HTML emails, and mobile websites &amp; applications
                  </li>
                  ...
                  <li>
                    Built an internal eDetailing framework based on Backbone, jQuery, Handlebars,
                    HammerJS, and custom components (with Node.js build tasks using Grunt)
                  </li>
            ...
            <details open={allOpen}>
              ...
              <div className="role">
                <ul>
                  ...
                  <li>
                    Built templates for third-party CMS systems (Kentico, BlogEngine.NET, FrogCMS,
                    bespoke .NET solutions)
                  </li>
                </ul>
              </div>
            </details>
            ...
            <details open={allOpen}>
              ...
              <div className="role">
                <ul>
                  <li>
                    Programming front-end interfaces including websites, landing pages, microsites,
                    HTML emails, and iPhone web applications
                  </li>
                  ...
                  <li>
                    Converted PSDs to standards-compliant, cross-browser-compatible
                    XHTML/CSS/JavaScript/jQuery/AJAX
                  </li>
                  <li>
                    Overseeing implementation of templates into an in-house .NET CMS and third-party
                    CMSs
                  </li>
                </ul>
              </div>
          ...
          <article className="job">
            <details open={allOpen}>
              ...
              <div className="role">
                <ul>
                  <li>
                    Implementing new templates using standards-compliant code and ensuring
